...
program.command('init')
    ...
    .option('-ru, --rdpusername <username>', 'username for RDP connection to the Windows Azure service')
    .option('-rp, --rdppassword <password>', 'password for RDP connection to the Windows Azure service')
